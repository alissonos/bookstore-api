package com.oliveira.bookstore.resources;
...
import com.oliveira.bookstore.dtos.LivroDTO;
import com.oliveira.bookstore.service.LivroService;
...
public class LivroResource {
	...
	@PostMapping
	public ResponseEntity<Livro> create(@RequestParam(value = "categoria", defaultValue = "0") Integer idCat,@Valid
